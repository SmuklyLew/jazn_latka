...
LEXICAL_RESOURCE_REGISTRY_SCHEMA = "lexical_resource_registry/v1"
...
class LexicalResourceStatus:
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            "schema_version": "lexical_resource_status/v1",
...
class LexicalResourceRegistry:
    ...
    def load_verified_sources(self) -> dict[str, Any]:
        return self._load_json(
            ...
            fallback={
                "schema_version": "verified_lexical_sources/v1",
                "sources": {},
                "policy": {},
...
def load_latka_project_lexicon(root: str | Path, path: str | Path | None = None) -> dict[str, Any]:
    ...
    if not lexicon_path.exists():
        return {
            "schema_version": "latka_project_lexicon/v1",
            "terms": {},
    ...
    data.setdefault("schema_version", "latka_project_lexicon/v1")
