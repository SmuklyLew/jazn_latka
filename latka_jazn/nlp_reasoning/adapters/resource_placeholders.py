...
def optional_provider_statuses(*, exclude: set[str] | None = None) -> list[ProviderStatus]:
    ...
    statuses = [
        ...
        ProviderStatus("stanza-pl", False, "offline_optional", "run tools/Install-JaznPolishReasoningResources.ps1 -Profile recommended", license="Apache-2.0 library; downloaded model licenses vary", source_url="https://stanfordnlp.github.io/stanza/download_models.html"),
    ...
    return [status for status in statuses if status.provider not in excluded]
