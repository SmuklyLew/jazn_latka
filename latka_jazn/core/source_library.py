...
# Kompatybilność z poprzednia linia runtime: dawny interfejs SOURCE_LIBRARY zostaje,
# ale dane są zasilane pełną biblioteką scientific_basis poprzednia linia runtime.
