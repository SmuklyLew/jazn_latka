...
class RuntimeActivationStatusHandler:
    ...
    def handle(self, text: str, context: dict[str, Any] | None = None) -> RouteHandlerResult:
        ...
        return RouteHandlerResult(self.name, route, body, intent=intent, generation_mode="runtime_activation_status_handler", required_components=ctx.get("required_components", []), satisfied_components=satisfied, source_origin_detail="runtime_activation_status_handler/v1", confidence=0.88)
