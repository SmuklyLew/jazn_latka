...
# v16.3.25.5.83 adds a local read-only JavaScript Runtime Console while
# preserving Python as the sole runtime/lifecycle/memory/turn authority.
# Browser ESM is presentation-only; Node.js remains an optional CI/tooling capability.
DISTRIBUTION_VERSION = "16.3.25.5.83"
PACKAGE_VERSION = "16.3.25.5.83"
PACKAGE_RELEASE_NAME = "javascript-runtime-console-convergence"
