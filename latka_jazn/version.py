...
# v16.3.25.5.72 adds capability-negotiated ChatGPT execution routing and
# a Pack Generator bootstrap contract that separates package completeness
# from host execution privileges.
DISTRIBUTION_VERSION = "16.3.25.5.72"
PACKAGE_VERSION = "16.3.25.5.72"
PACKAGE_RELEASE_NAME = "chatgpt-execution-route-pack-bootstrap-convergence"
