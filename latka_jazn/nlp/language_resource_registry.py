...
SCHEMA_VERSION="language_resource_registry/v1"
...
class LanguageResourceRegistry:
    ...
    def to_dict(self)->dict[str,Any]:
        ...
        return {'schema_version':SCHEMA_VERSION,'resources':data,'resource_count':len(data),'truth_boundary':'Rejestr wskazuje możliwe zasoby; runtime nie twierdzi, że pobrał wynik online bez realnego lookupu. SJP/WSJP są w poprzednia linia runtime bezpiecznymi referencjami linkowymi, nie scraperami definicji.'}
