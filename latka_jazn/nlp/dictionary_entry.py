...
SCHEMA_VERSION="dictionary_entry/v1"
...
class DictionaryLookupResult:
    ...
    # poprzednia linia runtime structural fields
    query: str | None = None
...
class NormalizedLexeme:
    term: str; normalized: str; language: str='pl'; provider: str='mini'; confidence: float=0.0; schema_version: str='normalized_lexeme/v1'
    def to_dict(self)->dict[str,Any]: return asdict(self)
@dataclass(slots=True)
class SemanticRelations:
    term: str; relation: str|None=None; related_terms: list[str]=field(default_factory=list); source_name: str='none'; confidence: float=0.0; schema_version: str='semantic_relations/v1'
    def to_dict(self)->dict[str,Any]: return asdict(self)
