...
def test_v1612_release_identity_and_release_metadata_accept_unprefixed_version() -> None:
    assert DISTRIBUTION_VERSION == "16.1.2"
    assert PACKAGE_VERSION == "16.1.2"
    assert PACKAGE_RELEASE_NAME == "private-memory-acceptance-benchmark"
    assert release_metadata_sync._impl._schema_version_for_runtime("release_test", PACKAGE_VERSION) == "release_test/16.1.2"
