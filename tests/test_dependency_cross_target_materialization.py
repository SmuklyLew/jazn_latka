...
from latka_jazn.dependencies.wheelhouse import (
    ...
    download_bundle,
    render_hash_lock_bytes,
)

ROOT = Path(__file__).resolve().parents[1]


def test_hash_lock_transport_is_canonical_utf8_lf() -> None:
    payload = render_hash_lock_bytes([
        {"name": "example", "version": "1", "sha256": "0" * 64},
    ])

    assert payload.startswith("# Generated by Jaźń".encode("utf-8"))
