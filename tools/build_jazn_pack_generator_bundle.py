...
"""Compatibility CI validator for Jaźń Pack Generator v10.1.86.0.115.
...
EXPECTED_GENERATOR_VERSION = "10.1.86.0.115"
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Validate Jaźń Pack Generator v10.1.86.0.115 source layout",
        allow_abbrev=False,
    )
