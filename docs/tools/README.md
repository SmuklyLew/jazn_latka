...
- `../runtime/JAZN_PACK_GENERATOR_V101860112_BYTE_EXACT_STAGING.md` — aktywny kontrakt Pack Generator 10.1.86.0.112: byte-exact staging, per-file SHA-256 i fail-closed EOL.
