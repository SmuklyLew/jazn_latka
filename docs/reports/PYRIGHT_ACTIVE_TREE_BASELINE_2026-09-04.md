...
| 1 | `tests/test_release_metadata_semantics.py:53` | `reportRedeclaration` | test typing | `_remove_git_metadata` is declared twice in the same test module. Keep the shared Windows-read-only implementation and remove the duplicate declaration. |
